...
rpm-ostree install foot stow podman-compose syncthing kitty fish emacs hypridle hyprlock rofi-wayland swww SwayNotificationCenter qtile qtile-wayland qtile-extras alacritty

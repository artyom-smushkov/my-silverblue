...
rpm-ostree install foot stow podman-compose syncthing kitty fish emacs hyprland hypridle hyprlock rofi-wayland dunst waybar river swww SwayNotificationCenter

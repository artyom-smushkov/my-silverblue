...
curl -O https://copr.fedorainfracloud.org/coprs/deltacopy/darkly/repo/fedora-42/deltacopy-darkly-fedora-42.repo
...
install -o 0 -g 0 -m644 deltacopy-darkly-fedora-42.repo /etc/yum.repos.d/deltacopy-darkly-fedora-42.repo

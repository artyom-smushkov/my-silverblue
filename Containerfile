...
RUN rpm-ostree install  xwayland-satellite wofi && ostree container commit
RUN rpm-ostree override remove sway --install niri sway-systemd sway-config-fedora sddm-wayland-sway --install sddm-wayland-generic && ostree container commit
